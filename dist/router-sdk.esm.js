  ...
  _proto.minimumAmountOut = function minimumAmountOut(slippageTolerance, amountOut) {
    ...
    !!slippageTolerance.lessThan(ZERO)
      ? process.env.NODE_ENV !== 'production'
        ...
        : invariant(false)
      : void 0 /// does not support exactOutput, as enforced in the constructor
      ...
      for (var _iterator3 = _createForOfIteratorHelperLoose(trades.swaps), _step3; !(_step3 = _iterator3()).done; ) {
        ...
        if (route.protocol == Protocol.V2) {
          individualTrades.push(
            new Trade$2(route, trades.tradeType == TradeType.EXACT_INPUT ? inputAmount : outputAmount, trades.tradeType)
          )
