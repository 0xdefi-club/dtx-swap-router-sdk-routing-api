...
var MixedRouteTrade = /*#__PURE__*/ (function () {
  ...
  function MixedRouteTrade(_ref) {
    ...
    for (var _iterator = _createForOfIteratorHelperLoose(routes), _step; !(_step = _iterator()).done; ) {
      ...
      for (var _iterator2 = _createForOfIteratorHelperLoose(route.pools), _step2; !(_step2 = _iterator2()).done; ) {
        ...
        pool instanceof v3Sdk.Pool
          ? poolAddressSet.add(v3Sdk.Pool.getAddress(pool.token0, pool.token1, pool.fee))
          : poolAddressSet.add(v2Sdk.Pair.getAddress(pool.token0, pool.token1))
      }
    }
  ...
  MixedRouteTrade.fromRoute =
    ...
    (function () {
      var _fromRoute = /*#__PURE__*/ _asyncToGenerator(
        /*#__PURE__*/ runtime_1.mark(function _callee(route, amount, tradeType) {
  ...
  MixedRouteTrade.fromRoutes =
    ...
    (function () {
      var _fromRoutes = /*#__PURE__*/ _asyncToGenerator(
        /*#__PURE__*/ runtime_1.mark(function _callee2(routes, tradeType) {
          var populatedRoutes,
            _iterator3,
            _step3,
            _step3$value,
  ...
  MixedRouteTrade.createUncheckedTradeWithMultipleRoutes = function createUncheckedTradeWithMultipleRoutes(
  ...
  MixedRouteTrade.bestTradeExactIn =
    ...
    (function () {
      var _bestTradeExactIn = /*#__PURE__*/ _asyncToGenerator(
        /*#__PURE__*/ runtime_1.mark(function _callee3(
          pools,
          currencyAmountIn,
          currencyOut,
              ...
              while (1) {
                switch ((_context3.prev = _context3.next)) {
                  ...
                  case 31:
                    ...
                    _context3.next = 36
                    return MixedRouteTrade.fromRoute(
                      new MixedRouteSDK([].concat(currentPools, [pool]), currencyAmountIn.currency, currencyOut),
                      currencyAmountIn,
                  ...
                  case 42:
                    ...
                    _context3.next = 46
                    return MixedRouteTrade.bestTradeExactIn(
                      poolsExcludingThisPool,
                      currencyAmountIn,
                      currencyOut,
                      {
...
var Trade = /*#__PURE__*/ (function () {
  ...
  Trade.fromRoutes = /*#__PURE__*/ (function () {
    var _fromRoutes = /*#__PURE__*/ _asyncToGenerator(
      /*#__PURE__*/ runtime_1.mark(function _callee(v2Routes, v3Routes, tradeType, mixedRoutes) {
        var populatedV2Routes,
          populatedV3Routes,
  ...
  Trade.fromRoute = /*#__PURE__*/ (function () {
    var _fromRoute = /*#__PURE__*/ _asyncToGenerator(
      /*#__PURE__*/ runtime_1.mark(function _callee2(route, amount, tradeType) {
        var v2Routes,
          v3Routes,
          mixedRoutes,
          v2Trade,
      ...
      function (_ref, pool, index) {
        ...
        if (index === 0) {
          return {
            ...
            path: [
              inputToken.address,
              pool instanceof v3Sdk.Pool ? pool.fee : V2_FEE_PATH_PLACEHOLDER,
              outputToken.address,
            ],
          }
        } else {
...
var partitionMixedRouteByProtocol = function partitionMixedRouteByProtocol(route) {
  ...
  while (right < route.pools.length) {
    if (
      (route.pools[left] instanceof v3Sdk.Pool && route.pools[right] instanceof v2Sdk.Pair) ||
      (route.pools[left] instanceof v2Sdk.Pair && route.pools[right] instanceof v3Sdk.Pool)
    ) {
...
var SwapRouter = /*#__PURE__*/ (function () {
  ...
  SwapRouter.encodeV2Swap = function encodeV2Swap(trade, options, routerMustCustody, performAggregatedSlippageCheck) {
    ...
    var recipient = routerMustCustody
      ...
      ? MSG_SENDER
      : sdkCore.validateAndParseAddress(options.recipient)
  ...
  SwapRouter.encodeMixedRouteSwap = function encodeMixedRouteSwap(
    trade,
    options,
    routerMustCustody,
      ...
      if (singleHop) {
        ...
        ;(function () {
          ...
          for (var i = 0; i < sections.length; i++) {
            ...
            var newRouteOriginal = new MixedRouteSDK(
              [].concat(section),
            ...
            if (mixedRouteIsAllV3(newRoute)) {
              ...
              var _exactInputParams2 = [
                i == 0 ? amountIn : 0,
                !isLastSectionInRoute(i) ? 0 : amountOut,
                newRoute.path.map(function (token) {
                  return token.address
                }),
  ...
  SwapRouter.encodeSwaps = function encodeSwaps(trades, options, isSwapAndAdd) {
    ...
    if (trades instanceof Trade) {
      !trades.swaps.every(function (swap) {
        return (
          swap.route.protocol == exports.Protocol.V3 ||
          swap.route.protocol == exports.Protocol.V2 ||
          swap.route.protocol == exports.Protocol.MIXED
        )
      })
      ...
      for (var _iterator3 = _createForOfIteratorHelperLoose(trades.swaps), _step3; !(_step3 = _iterator3()).done; ) {
        ...
        if (route.protocol == exports.Protocol.V2) {
          individualTrades.push(
            new v2Sdk.Trade(
              route,
              trades.tradeType == sdkCore.TradeType.EXACT_INPUT ? inputAmount : outputAmount,
              trades.tradeType
            )
          )
        } else if (route.protocol == exports.Protocol.V3) {
          individualTrades.push(
            v3Sdk.Trade.createUncheckedTrade({
              route: route,
              inputAmount: inputAmount,
              outputAmount: outputAmount,
    ...
    var numberOfTrades = trades.reduce(function (numberOfTrades, trade) {
      return (
        numberOfTrades + (trade instanceof v3Sdk.Trade || trade instanceof MixedRouteTrade ? trade.swaps.length : 1)
      )
    }, 0)
      ...
      if (trade instanceof v2Sdk.Trade) {
        ...
        for (
          var _iterator6 = _createForOfIteratorHelperLoose(
              SwapRouter.encodeMixedRouteSwap(trade, options, routerMustCustody, performAggregatedSlippageCheck)
            ),
            _step6;
  ...
  SwapRouter.swapCallParameters = function swapCallParameters(trades, options) {
    ...
    if (
      inputIsNative &&
      (sampleTrade.tradeType === sdkCore.TradeType.EXACT_OUTPUT || SwapRouter.riskOfPartialFill(trades))
    ) {
  ...
  SwapRouter.swapAndAddCallParameters = function swapAndAddCallParameters(
    ...
    if (tokenInApprovalType !== exports.ApprovalTypes.NOT_REQUIRED)
      calldatas.push(ApproveAndCall.encodeApprove(tokenIn, tokenInApprovalType))
    if (tokenOutApprovalType !== exports.ApprovalTypes.NOT_REQUIRED)
